...
function mainSlider() {
    ...
    if(slider.length){
        ...
        if (caps.find('.btn-orange')) {
            TweenLite.set(caps.find('.btn-orange'), {css: {'position': 'relative'}});
        }
    }
    slider.on('beforeChange', function(event, slick, currentSlide, nextSlide){
        var caption = slider.find(".slick-slide[data-slick-index=" + nextSlide + "]");
            befores = slider.find(".slick-slide[data-slick-index=" + currentSlide + "]");

        TweenLite.to(caption.find('h2'), 0.2, {css: {'top': '-50px','opacity': '0',},ease: Quart.easeOut});
        if (caption.find('p')) {
            TweenLite.to(caption.find('p'), 0.2, {css: {'bottom': '-50px','opacity': '0',},ease: Quart.easeOut});
        }
        if (caption.find('.btn-orange')) {
            TweenLite.to(caption.find('.btn-orange'), 0.2, {css: {'bottom': '-50px','opacity': '0',},ease: Quart.easeOut});
        }
    ...
    slider.on('afterChange', function(event, slick, currentSlide){
        ...
        TweenLite.to(caption.find('h2'), 0.8, {css: {'top': '0','opacity': '1',},delay: 0.4,ease: Quart.easeOut});
        if (caption.find('p')) {
            TweenLite.to(caption.find('p'), 0.8, {css: {'bottom': '0','opacity': '1',},delay: 0.6,ease: Quart.easeOut});
        }
        if (caption.find('.btn-orange')) {
            TweenLite.to(caption.find('.btn-orange'), 0.8, {css: {'bottom': '0','opacity': '1',},delay: 0.8,ease: Quart.easeOut});
        }
...
function menuMobile() {
    ...
    $('.menu-mobile > .menum > .dropdown > span').click(function(){
    ...
    $('.accordion-title').click(function(){
        ...
        if ($(this).hasClass('active')) {
            ...
            $(parent).find('> .accordion-panel').each(function(){
                $(this).find('> .accordion-collapse').removeClass('collapse in').slideUp(400);
            });
        }else{
            $(this).addClass('active');
            $(this).parent().find('> .accordion-title').not($(this)).removeClass('active');
            $(parent).find('> .accordion-panel > .accordion-heading > .accordion-title').not($(this)).each(function(){
                $(this).removeClass('active');
            });
            $(parent).find('> .accordion-panel').each(function(){
                var content = $(this).find('> .accordion-collapse').attr('id');
                if (id == content) {
                    $('#'+content).addClass('collapse in').slideDown(400);
                }else{
                    $('#'+content).removeClass('collapse in').slideUp(400);
                }
            });
        }
    });
